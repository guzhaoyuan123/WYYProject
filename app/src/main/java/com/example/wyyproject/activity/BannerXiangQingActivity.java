...
public class BannerXiangQingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banner_xiang_qing);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BannerXiangQingActivity.this.finish();
            }
        });
        ...
        if(bundle != null) {
            final String news =  bundle.getString("news");
            wvNews.loadUrl(news);
