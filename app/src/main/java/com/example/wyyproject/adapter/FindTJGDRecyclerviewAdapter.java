...
public class FindTJGDRecyclerviewAdapter extends RecyclerView.Adapter<FindTJGDRecyclerviewAdapter.ViewHolder> {
    ...
    public FindTJGDRecyclerviewAdapter(Context context, List<ResultBean> resultBeans) {
